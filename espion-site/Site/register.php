    ...
    <style>
        ...
        * {
        ...
        main {
            ...
            padding: 3rem 1.5rem;
            background:
                radial-gradient(ellipse at 50% 30%, rgba(37, 99, 235, 0.06) 0%, transparent 65%),
                var(--dark);
        }
...
<main>
    <div class="card">
        ...
        <div class="alert-success">
            ...
            <p>Bienvenue dans l'agence. <a href="login.php">Connectez-vous</a> pour accéder à votre espace agent.</p>
        </div>
